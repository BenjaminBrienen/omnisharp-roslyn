...
public class ReferencesChangedEventArgs : ScriptChangedEventArgs
{
    ...
    public ReferencesChangedEventArgs(string scriptPath, ISet<string> references) : base(scriptPath) => References = references ?? new HashSet<string>();
}
...
public class UsingsChangedEventArgs : ScriptChangedEventArgs
{
    ...
    public UsingsChangedEventArgs(string scriptPath, IReadOnlyCollection<string> usings) : base(scriptPath) => Usings = usings ?? new List<string>();
}
